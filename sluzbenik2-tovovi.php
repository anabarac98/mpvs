<?php
    ...
    if (isset($_POST['save_proces'])) {
        ...
        if ($query1_run) {
            ...
            header ("Location: sluzbenik2-tovovi.php");
...
<html lang="en">
    ...
    <body>
        ...
        <ul class="noPrint">
            ...
            <li><a class="active" href="sluzbenik2-tovovi.php">Slanje timova na teren - tovovi</a></li>
        ...
        <br>
        <p style="margin-left:10px;font-weight:bold;" class="noPrint"> LISTA P-1 OBRAZACA GDJE NIJE OBAVLJEN TEREN - TOVOVI</p>
        <br>
        ...
        <table style='width:100%'>
            ...
            <tr class="header" style="background-color:black;color:white;text-align:center;font-size:14px;" }>
                <th style='width:4%'>PROTOKOL</th>
                <th style='width:7%'>IME I PREZIME</th>
                <th style='width:6%'>TELEFON</th>
                <th style='width:6.5%'>ULICA</th>
                <th style='width:3%'>BROJ</th>
                <th style='width:8%'>OPĆINA/GRAD</th>
                <th style='width:10%'>PROIZVODNJA</th>
                <th style='width:6.5%'>DATUM POČETKA</th>
                <th style='width:7%'>KRAJNJI ROK ZA SAČINJAVANJE ZAPISNIKA</th>
                <th style='width:6.5%'>DATUM ZAVRŠETKA</th>
                <th style='width:6.5%'>KRAJNJI ROK ZA SAČINJAVANJE ZAPISNIKA</th>
                <th style='width:7.5%'>ROK ZA KRAJ TOVA</th>
                <th style='width:4%'>TEREN</th>
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    if ($proizvodnja == 'Proizvodnja goveđeg mesa - tov junadi' or $proizvodnja == 'Proizvodnja goveđeg mesa - tov junadi iz uvoza' or $proizvodnja == 'Proizvodnja svinjskog mesa - tov svinja' ){
                        ...
                        <tr style='".$style."; font-size:16px;'>
                            <td style='padding:4px;width:4%;'><input style='".$style.";width:4%;border:none;' type='hidden' name='protokol' value='".$row['protokol']."'readonly> ".$row['protokol']." </td>
                            <td style='padding:4px;width:7%;'>".$row['ime']." ".$row['prezime']."</td>
                            <td style='padding:4px;width:6%;'>".$row['telefon']."</td>
                            <td style='padding:4px;width:6.5%;'>".$row['ulica']."<input style='".$style.";border:none;width:6.5%;font-size:16px;' type='hidden' name='ulica' value='".$row['ulica']."'readonly> </td>
                            <td style='padding:4px;width:3%;'>".$row['broj']."</td>
                            <td style='padding:4px;width:8%;'>".$row['opcina']."<input style='".$style.";border:none;font-size:16px;' type='hidden' name='opcina' value='".$row['opcina']."'readonly> </td>
                            <td style='padding:4px;width:10%;'>".$row['proizvodnja']."</td>
                            <td style='padding:4px;text-align:center;width:6.5%;'>".$mysqldate."</td>";

                            //DATUM POČETKA PA DATUM ZA KRAJ ROKA ZAPISNIKA.
                            ...
                            echo "<td style='width:4%;padding:4px;text-align:center;'>".$row['stanje']."</td>
                            <td style='width:4%;padding:4px;text-align:center;'>".$row['tim']."</td>";


                            //Select za dodjelu timova - 
                            if($row['tim']=="") {
