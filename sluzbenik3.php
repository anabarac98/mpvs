<?php
    ...
    if (isset($_POST['save_proces'])) {
        ...
        $query1 = "UPDATE obrazac SET status_komplet = 'Odrađen' WHERE protokol = '".mysqli_real_escape_string($link, $_POST['protokol'])."' LIMIT 1";
...
<html lang="en">
    ...
    <body>
        ...
        <!--Navigacijska traka -->
        <ul class="noPrint">
            <li><a class="active" href="sluzbenik3.php">KONAČNO ODRAĐEN P-1 (teren + dokumentacija)</a></li>
            <li><a href="sluzbenik3-pregled.php">Pregled stanja</a></li>
        ...
        <br>
        <p style="margin-left:10px;font-weight:bold;" class="noPrint"> LISTA P-1 OBRAZACA GDJE JE OBAVLJEN TEREN </p>
        <br>
        ...
        <table style='width:100%'>
            ...
            <tr class="header" style="background-color:black;color:white;text-align:center;font-size:15px;" }>
                ...
                <th style='width:10%'>ROK ZA KRAJ TOVA</th>
            ...
            <?php
                ...
                $sql = "SELECT * FROM obrazac WHERE stanje = 'Odrađen' AND status_komplet = 'Neodrađen' ORDER BY opcina ASC, ulica ASC, broj ASC, prezime ASC, ime ASC";
                ...
                while($row = $result -> fetch_assoc()){
                    ...
                    <tr style='".$style."; font-size:17px;'>
                        ...
                        //DATUM POČETKA I ROK ZA 1.ZAPISNIK
                        if ($row1['rok_zapisnik'] == "-" or $row1['rok_zapisnik'] == "" or $row1['rok_zapisnik'] == "" or $row1['rok_zapisnik'] == "/" ){
                            ...
                            echo "<td style='width:6%;'>".$dt->format('d.m.Y.')."</td>";
                        ...
                        <td style='width:4%;padding:4px;'>
                        <input type='hidden' name='submit' value='0'>
                        <button name='save_proces' type='submit' class='button noPrint'> Odrađeno </button>
                        </td>
                    </tr>
